...
return new class extends Migration
{
    ...
    public function up(): void
    {
        ...
        if ($driver === 'sqlite') {
            DB::statement("DROP VIEW IF EXISTS client_bond_payout_summary");
            DB::statement("
                CREATE VIEW client_bond_payout_summary AS
                ...
                LEFT JOIN (
                    ...
                    WHERE
                        ...
                        (started = 0 AND strftime('%Y', next_capital_payout) = strftime('%Y', 'now'))
                    GROUP BY client_id
                ...
                LEFT JOIN (
                    ...
                    FROM client_bonds
                    WHERE ended = 0
                      AND next_capital_payout >= date('now')
                    GROUP BY client_id
